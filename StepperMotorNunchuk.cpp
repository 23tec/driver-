...
// Contoller for stepper motor with nunchuck

/*
**Functionality:**
- **Joystick Control**: Manually controls:
...
- **Z Button (Automatic Mode)**:
  - Press Z while tilting the joystick to save the current direction and speed for automatic mode.
  - Press Z again to exit automatic mode, retaining the saved speed.

- **C Button (Reset)**:
  - Press C to clear saved data, disabling automatic mode and resetting for a new recording.
*/
#include <Arduino.h>
...
unsigned long __angle = 0;

bool automatic = false;
bool memVelocity = false;
